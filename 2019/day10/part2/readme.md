...
The Elves are placing bets on which will be the __200th__ asteroid to be vaporized. Win the bet by determining which asteroid that will be; __what do you get if you multiply its X coordinate by `100` and then add its Y coordinate__? (For example, `8,2` becomes `802`.)
