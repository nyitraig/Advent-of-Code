...
To make sure the image wasn't corrupted during transmission, the Elves would like you to find the layer that contains the __fewest `0` digits__. On that layer, what is __the number of `1` digits multiplied by the number of `2` digits__?
